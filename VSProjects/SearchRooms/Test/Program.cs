...
namespace Test
{
    ...
    public class SearchForRoom
    {
        ...
        /// <summary>
        /// Gets Computer Mac Address in order to determine what room ending to add.
        /// </summary>
        /// <returns>Returns mac address as string.</returns>
        public string GetDefaultMacAddress()
        {
            ...
            foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
            {
                if (nic.OperationalStatus == OperationalStatus.Up)
                    macAddresses[nic.GetPhysicalAddress().ToString()] = nic.GetIPv4Statistics().BytesSent + nic.GetIPv4Statistics().BytesReceived;
            }
            long maxValue = 0;
            string mac = "";
